        ...
        $query = "SELECT
				...
				FROM
					...
					LEFT OUTER JOIN vtiger_potential 
						ON vtiger_potential.potentialid = vtiger_purchaseorder.potentialid 
					LEFT JOIN vtiger_groups 
						ON vtiger_groups.groupid = vtiger_crmentity.smownerid 
					LEFT JOIN vtiger_purchaseordercf 
						ON vtiger_purchaseordercf.purchaseorderid = vtiger_purchaseorder.purchaseorderid 
					LEFT JOIN vtiger_payment_recurring_info 
						ON vtiger_payment_recurring_info.start_period = vtiger_purchaseorder.purchaseorderid 
				...
				WHERE
					...
					AND vtiger_potential.potentialid =".$id;
