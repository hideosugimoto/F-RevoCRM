...
class PaymentHandler extends VTEventHandler {
    ...
    function handleEvent($eventName, $entityData) {
        ...
        if ($eventName == 'vtiger.entity.aftersave') {
            ...
            $wsid = vtws_getWebserviceEntityId('Payment', $entityData->getId());
            ...
            if ($wsrecord['balance'] == 0) {
                $wsrecord['paymentstatus'] = 'Paid';
            }
            $query = "UPDATE vtiger_payment SET balance=?,received=? WHERE paymentid=?";
