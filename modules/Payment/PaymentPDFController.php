...
class Vtiger_PaymentPDFController extends Vtiger_InventoryPDFController{
	function buildHeaderModelTitle() {
		...
		return sprintf("%s: %s", $translatedSingularModuleLabel, $this->focusColumnValue('payment_no'));
	}
	...
	function getWatermarkContent() {
		return $this->focusColumnValue('paymentstatus');
	}
}
?>
